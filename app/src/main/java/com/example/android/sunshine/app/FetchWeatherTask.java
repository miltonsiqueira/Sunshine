    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                ContentValues[] arrContentValues = new ContentValues[cVVector.size()];
                cVVector.toArray(arrContentValues);
                mContext.getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, arrContentValues);
